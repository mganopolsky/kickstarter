...
The dataset I have chosen is the [Kickstarter Dataset from Kaggle](https://www.kaggle.com/kemical/kickstarter-projects?select=ks-projects-201801.csv). 
...
```{r, summary_ds, echo=TRUE, include=TRUE, warning=FALSE}
```
...
```
This is definitely an error in the data, for multiple reasons. Let's plot what time period this takes place during:
